...
func createMediaRenditionAction(xRefTable *XRefTable, mediaClipDataDict *IndirectRef) *PDFDict {
...
func createSelectorRenditionAction(mediaClipDataDict *IndirectRef) *PDFDict {
