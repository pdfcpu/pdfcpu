...
func TestBooklet(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{"TestBookletFromPDF8Up",
			...
			nil,
			"p:A3, enforce:on", // need to enforce orientation for 8up because portrait pdf input gets rotated onto sheet
			"points",
			8,
			false,
		},
