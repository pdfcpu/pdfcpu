...
func TestStatelessRepositoryUsesCoreFontsOnly(t *testing.T) {
	...
	if _, err := repo.TextBoundingBox("text", "CachedElsewhere", 12); !errors.Is(err, ErrUnknownFont) {
...
func TestRepositoryReturnsDetachedMetrics(t *testing.T) {
	...
	got, ok, err := repo.UserFont("Detached")
	if err != nil || !ok {
