...
| strokecolor      | for rendering text (see mode)   | [color](/getting_started/color)                | 0.5, 0.5, 0.5 = gray
| fillcolor, color | for rendering text (see mode)   | [color](/getting_started/color)                | 0.5, 0.5, 0.5 = gray
| backgroundcolor  | bounding box background         | [color](/getting_started/color)                | 
...
2. Follow [the instructions](/fonts/fonts_install) to install the font you would like to use.
