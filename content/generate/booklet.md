...
For long-edge binding, pages are arranged similar to 4-up with btype=booklet, but with an additional rotation to fit the pages on the sheet. For short-edge binding, pages are arranged similar to 6-up (left-to-right, top-to-bottom order). To assemble:
