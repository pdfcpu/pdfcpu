...
* An alternative to [poster](/generate/poster) and [cut](/generate/cut)
...
* See also the related commands: [poster](/generate/poster), [cut](/generate/cut)
...
The following table lists all supported values for `n` and the resulting poster tile layout with respect to the orientation of the chosen output [paper size](/paper).
...
| bgcolor              | margin / glue area color value | [color](/getting_started/color)
