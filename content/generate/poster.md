...
* See also the related commands: [ndown](/generate/ndown), [cut](/generate/cut)
...
| formsize             | Paper to be used. Append L or P to enforce landscape/portrait mode | [paper size](/paper)
